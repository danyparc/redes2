...
public class Server3 extends Thread{
    ...
    public Server3() throws SocketException {
        super("Server");
    ...
    public void run() {
       while (moreQuotes) {
            try {
                File f = new File("/Users/Callmetorre/NetBeansProjects/Ejemplo/Curriculum.docx");
                nombre = f.getName();
                tam = f.length();
                ruta = f.getPath();
                ...
                DatagramPacket packet = new DatagramPacket(b, b.length, group, 4448);
                socket.send(packet);
		...
		long enviados = 0;
                ...
                while(enviados < tam){
                   ...
                   if(d.sec == 2){                   
                    ...
                    DatagramPacket p2 = new DatagramPacket(datos, datos.length, group, 4448);
