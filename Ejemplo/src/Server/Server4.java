...
public class Server4 extends Thread{
    ...
    public Server4() throws SocketException {
        super("Server");
        socket = new DatagramSocket(4442);
    }
    ...
    public void run() {
       while (moreQuotes) {
            try {
                ...
                tam = f.length();
                ruta = f.getPath();
                //cambiar este numero entre el numero de servidores que hay
                buf_len = (int) (tam/4);
                ...
                DatagramPacket packet = new DatagramPacket(b, b.length, group, 4449);
                socket.send(packet);
		...
		long enviados = 0;
                ...
                while(enviados < tam){
                    ...
                    DatagramPacket p2 = new DatagramPacket(datos, datos.length, group, 4449);
